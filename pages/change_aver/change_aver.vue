	...
	<view class="container">
		<view class="page-body uni-content-info">
			...
			<view class='cropper-config'>
				<button type="primary reverse" @click="getImage">选择图片</button>
				<button type="warn" @click="getImageInfo" style='margin-left: 30upx;'>点击生成图片</button>
			</view>
			<view class="submit">
				<button @click="submit()">生成头像</button>
			</view>
			...
			loadImage: function () {
				...
				uni.getImageInfo({
					...
					success: function success(res) {
						...
						if (IMG_RATIO >= 1) {
							let cutT = Math.ceil((SCREEN_WIDTH / IMG_RATIO - (SCREEN_WIDTH / IMG_RATIO - INIT_DRAG_POSITION)) / 4);
							let cutB = cutT;
							let cutL = Math.ceil((SCREEN_WIDTH - SCREEN_WIDTH + INIT_DRAG_POSITION));
							let cutR = cutL;
							_this.setData({
								cropperW: SCREEN_WIDTH,
							...
							let cutR = cutL;
							let cutT = Math.ceil((SCREEN_WIDTH - INIT_DRAG_POSITION) / 4);
							let cutB = cutT;
							_this.setData({
